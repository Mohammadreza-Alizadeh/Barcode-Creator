$.fn.progressScroll=function(e){
    ...
    this.prepare = function () {
        ...
        $(".progressScroll").css({ width: r.width, height: r.height, position: "fixed", bottom: "20px", left: "20px" });
        ...
        $("." + d, a).css({ position: "relative", top: "50%", left: "40%", transform: "translate(-50%, -50%)", "text-align": "center", width: r.width - r.borderSize, height: r.height - r.borderSize, "border-radius": "50%", "background-color": r.mainBgColor });
